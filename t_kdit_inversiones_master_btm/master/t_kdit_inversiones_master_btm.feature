@kdit
Feature: Tests for t_kdit_inversiones_master_btm in kdit

  @execute
  Scenario: t_kdit_inversiones_master_btm-master-punctual
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/kdit/master/t_kdit_inversiones_master_btm/${version}/t_kdit_inversiones_master_btm.conf
