@kdit
Feature: Tests for t_kdit_phaccount_alm in kdit

  @execute
  Scenario: t_kdit_phaccount_alm-master-punctual
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/kdit/master/t_kdit_phaccount_alm/${version}/t_kdit_phaccount_alm.conf
