@kdit
Feature: Tests for foliosbtm in kdit

  @execute
  Scenario: foliosbtm-master-punctual
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/kdit/master/foliosbtm/${version}/foliosbtm.conf
