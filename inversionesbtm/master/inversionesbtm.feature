@kdit
Feature: Tests for inversionesbtm in kdit

  @execute
  Scenario: inversionesbtm-master-punctual
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/kdit/master/inversionesbtm/${version}/inversionesbtm.conf
