...
Feature: Tests for inversionesbtm in kdit
  ...
  @execute
  Scenario: inversionesbtm-raw-punctual
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/kdit/raw/inversionesbtm/${version}/inversionesbtm.conf
