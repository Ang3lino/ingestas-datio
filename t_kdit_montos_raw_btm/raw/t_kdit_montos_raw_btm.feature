@kdit
Feature: Tests for t_kdit_montos_raw_btm in kdit

  @execute
  Scenario: t_kdit_montos_raw_btm-raw-punctual
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/kdit/raw/t_kdit_montos_raw_btm/${version}/t_kdit_montos_raw_btm.conf
