...
Feature: Tests for t_kdit_captation_alm in kdit
  ...
  @execute
  Scenario: t_kdit_captation_alm-raw-punctual
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/kdit/raw/t_kdit_captation_alm/${version}/t_kdit_captation_alm.conf
